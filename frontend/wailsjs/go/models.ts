export namespace backend {
	...
	export class DataFormatInfo {
	    ...
	    static createFrom(source: any = {}) {
	        return new DataFormatInfo(source);
	    }
	...
	export class ExtendedTuzhongInfo {
	    imageSize: number;
	    hiddenSize: number;
	    totalSize: number;
	    imageFormat: string;
	    ...
	    static createFrom(source: any = {}) {
	        return new ExtendedTuzhongInfo(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.dataFormat = this.convertValues(source["dataFormat"], DataFormatInfo);
